// audit.mjs — projektantská kontrola modelu. Spouštět: node audit.mjs
...
import { SPEC, levelBase, roofY } from './src/spec.js'
import { fitoutAll, FURN } from './src/fitout.js'
import { computeMEP } from './src/mep.js'
import { stairOpening } from './src/building.js'
...
const PAIR_OK = new Set([
  'chair|desk', 'chair|table', 'chair|rtable', 'chair|mtable', 'chair|partyTable',
...
import('./src/building.js').then(({ openingsFor }) => {
  ...
  console.log(`\n=== AUDIT: ${findings.length} nálezů ===`, JSON.stringify(bySev), '\n')
